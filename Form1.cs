...
namespace WindowsApplication1
{
	public partial class Form1 : Form
	{
		...
		this.Label6RV.MouseHover += ew EventHandler(form12.Label6RV_Hover);				
		...
		this.LinkLabelCounty.LinkClicked += ew LinkLabelLinkClickedEventHandler(form1.LinkLabelCounty_LinkClicked);
