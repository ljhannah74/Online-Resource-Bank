...
namespace WindowsApplication1
{
	...
	public class Form1 : Form
	{
		...
		[AccessedThroughProperty("pboxOpenRunSheet")]
		private PictureBox _pboxOpenRunSheet;
		...
		[AccessedThroughProperty("LabelUseIns")]
		private Label _LabelUseIns;

		[AccessedThroughProperty("LabelUseProps")]
		private Label _LabelUseProps;

		[AccessedThroughProperty("LabelUseCopy")]
		private Label _LabelUseCopy;
		...
		[AccessedThroughProperty("LabelUseTap")]
		private Label _LabelUseTap;

		[AccessedThroughProperty("LabelUseDtree")]
		private Label _LabelUseDtree;
		...
		[AccessedThroughProperty("LinkLabel16")]
		private LinkLabel _LinkLabel16;

		[AccessedThroughProperty("LabelUseRV")]
		private Label _LabelUseRV;

		[AccessedThroughProperty("GroupBox2")]
		private GroupBox _GroupBox2;

		[AccessedThroughProperty("LabelSubNeeded")]
		private Label _LabelSubNeeded;
		...
		[AccessedThroughProperty("LabelIndex_source")]
		private Label _LabelIndex_source;

		[AccessedThroughProperty("LabelCopyPmtType")]
		private Label _LabelCopyPmtType;

		[AccessedThroughProperty("Label26")]
		private Label _Label26;

		[AccessedThroughProperty("LabelImage_date")]
		private Label _LabelImage_date;

		[AccessedThroughProperty("LabelIndex_date")]
		private Label _LabelIndex_date;
		...
		[AccessedThroughProperty("LabelCopy_source")]
		private Label _LabelCopy_source;

		[AccessedThroughProperty("lblOpenRunSheet")]
		private Label _lblOpenRunSheet;

		[AccessedThroughProperty("TabControl1")]
		private TabControl _TabControl1;

		[AccessedThroughProperty("TabPg1Docs")]
		private TabPage _TabPg1Docs;

		[AccessedThroughProperty("TabPg2PhBk")]
		private TabPage _TabPg2PhBk;

		[AccessedThroughProperty("TabPg3Cal")]
		private TabPage _TabPg3Cal;

		[AccessedThroughProperty("TabPg4Clearing")]
		private TabPage _TabPg4Clearing;

		[AccessedThroughProperty("TabPg5Req")]
		private TabPage _TabPg5Req;

		[AccessedThroughProperty("TabPg6OtherLogins")]
		private TabPage _TabPg6OtherLogins;

		[AccessedThroughProperty("lblSOL_Heloc")]
		private Label _lblSOL_Heloc;

		[AccessedThroughProperty("Label_heloc")]
		private Label _Label_heloc;

		[AccessedThroughProperty("lblSOL_Mtg")]
		private Label _lblSOL_Mtg;

		[AccessedThroughProperty("Label_mtg")]
		private Label _Label_mtg;

		[AccessedThroughProperty("Label_spousal")]
		private Label _Label_spousal;

		[AccessedThroughProperty("lblSOL_Spousal")]
		private Label _lblSOL_Spousal;

		[AccessedThroughProperty("Label_taxTakRedem")]
		private Label _Label_taxTakRedem;

		[AccessedThroughProperty("lblSOL_Tax_RedemPer")]
		private Label _lblSOL_Tax_RedemPer;

		[AccessedThroughProperty("lblSOL_Creditor_Claims")]
		private Label _lblSOL_Creditor_Claims;

		[AccessedThroughProperty("Label_credclaim")]
		private Label _Label_credclaim;
		...
		[AccessedThroughProperty("txtTaxOffice1")]
		private TextBox _txtTaxOffice1;

		[AccessedThroughProperty("pbxCopy5")]
		private PictureBox _pbxCopy5;

		[AccessedThroughProperty("txtTaxOffice2")]
		private TextBox _txtTaxOffice2;

		[AccessedThroughProperty("pbxCopy4")]
		private PictureBox _pbxCopy4;

		[AccessedThroughProperty("txtTaxOffice3")]
		private TextBox _txtTaxOffice3;

		[AccessedThroughProperty("pbxCopy3")]
		private PictureBox _pbxCopy3;

		[AccessedThroughProperty("txtTaxOffice4")]
		private TextBox _txtTaxOffice4;

		[AccessedThroughProperty("pbxCopy2")]
		private PictureBox _pbxCopy2;

		[AccessedThroughProperty("txtTaxOffice5")]
		private TextBox _txtTaxOffice5;

		[AccessedThroughProperty("pbxCopy1")]
		private PictureBox _pbxCopy1;

		[AccessedThroughProperty("lblTxAuth1")]
		private Label _lblTxAuth1;

		[AccessedThroughProperty("linkLocTax1")]
		private LinkLabel _linkLocTax1;

		[AccessedThroughProperty("linkLocTax5")]
		private LinkLabel _linkLocTax5;

		[AccessedThroughProperty("lblTxAuth5")]
		private Label _lblTxAuth5;

		[AccessedThroughProperty("lblTxAuth2")]
		private Label _lblTxAuth2;

		[AccessedThroughProperty("linkLocTax2")]
		private LinkLabel _linkLocTax2;

		[AccessedThroughProperty("linkLocTax4")]
		private LinkLabel _linkLocTax4;

		[AccessedThroughProperty("lblTxAuth4")]
		private Label _lblTxAuth4;

		[AccessedThroughProperty("lblTxAuth3")]
		private Label _lblTxAuth3;

		[AccessedThroughProperty("linkLocTax3")]
		private LinkLabel _linkLocTax3;

		[AccessedThroughProperty("Label39")]
		private Label _Label39;

		[AccessedThroughProperty("pbxExport")]
		private PictureBox _pbxExport;
		...
		private void Button_EditORB_Click(object sender, EventArgs e)
		{
			...
			MyProject.Forms.frm_Edit.cboxState_EditORB.Text = this.ComboBoxState.Text;
			MyProject.Forms.frm_Edit.cboxCounty_EditORB.Text = this.ComboBoxCounty.Text;
			MyProject.Forms.frm_Edit.cboxTaxAuth_EditORB.Text = this.ComboBoxTaxAuth.Text;
			MyProject.Forms.frm_Edit.cboxTaxAuthType_EditORB.Text = this.ComboBoxTaxType.Text;
			MyProject.Forms.frm_Edit.Button_SEARCH.PerformClick();
		}
		...
		private void Form1_Load(object sender, EventArgs e)
		{
			...
			this.LoadForm(MyProject.Forms.frm_Edit, "");
		...
		private void InitializeComponent()
		{
			...
			point = new Point(514, 26);
			label32.Location = point;
			this.Label32.Name = "Label32";
			Label label = this.Label32;
			...
			SplitContainer splitContainer1 = this.SplitContainer1;
			point = new Point(0, 6);
			...
			SplitContainer splitContainer = this.SplitContainer1;
			size = new System.Drawing.Size(874, 385);
			...
			Label lblAttyState = this.lbl_attyState;
			point = new Point(262, 4);
			lblAttyState.Location = point;
			this.lbl_attyState.Name = "lbl_attyState";
			Label lblAttyState1 = this.lbl_attyState;
			size = new System.Drawing.Size(10, 15);
			lblAttyState1.Size = size;
			...
			size = new System.Drawing.Size(238, 35);
			...
			Label lblDefaultUWName = this.lblDefault_UW_Name;
			point = new Point(262, 26);
			lblDefaultUWName.Location = point;
			this.lblDefault_UW_Name.Name = "lblDefault_UW_Name";
			Label lblDefaultUWName1 = this.lblDefault_UW_Name;
			size = new System.Drawing.Size(10, 15);
			lblDefaultUWName1.Size = size;
			...
			point = new Point(0, 44);
			panel1.Location = point;
			this.Panel1.Name = "Panel1";
			Panel panel = this.Panel1;
			size = new System.Drawing.Size(874, 65);
			panel.Size = size;
			...
			Button buttonExit = this.ButtonExit;
			point = new Point(811, 25);
			buttonExit.Location = point;
			this.ButtonExit.Name = "ButtonExit";
			Button button = this.ButtonExit;
			size = new System.Drawing.Size(59, 35);
			button.Size = size;
		...
		private void LoadForm(frm_Edit oForm, string Title)
		{
			frm_Edit size = oForm;
			size.TopLevel = false;
			size.ShowInTaskbar = false;
			size.Size = this.Panel2.Size;
			this.Panel2.Controls.Add(oForm);
			size.Show();
			size = null;
		}
